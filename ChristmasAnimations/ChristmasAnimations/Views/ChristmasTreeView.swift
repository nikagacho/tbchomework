...
struct ChristmasTreeView: View {
    ...
    @State private var colors = [Color.red, Color.orange, Color.yellow, Color.pink]
    ...
    var body: some View {
        ZStack {
            ...
            FireworksView()
            VStack {
                Text("Merry Christmas TBC IT Academy")
                    .font(.system(size: 30))
                    .bold()
                    ...
                    .onAppear {
                        withAnimation(.easeInOut(duration: 2).repeatForever(autoreverses: true)) {
                            colors = [Color.green, Color.blue, Color.brown, Color.black]
                        }
                    }
